...
let CheckInsController = class CheckInsController {
    ...
    async verifyCheckIn(req, dto) {
        return this.checkInsService.verifyCheckIn({
            ...dto,
            gymId: req.user.gymId,
        });
    }
    async manualOverride(req, dto) {
        return this.checkInsService.manualOverride(req.user.gymId, req.user.id, dto.memberId);
    }
    async getLogs(req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], CheckInsController.prototype, "manualOverride", null);
__decorate([
    (0, common_1.Get)('logs'),
    (0, roles_decorator_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.STAFF),
    __param(0, (0, common_1.Request)()),
    ...
    __metadata("design:returntype", Promise)
], CheckInsController.prototype, "getLogs", null);
